...
function create_java_env() {
    ...
    echo "JVMFLAGS=\"-Xmx$ZK_HEAP_SIZE -Xms$ZK_HEAP_SIZE -javaagent:/opt/zookeeper/prometheus/jmx_prometheus_javaagent.jar=9404:/opt/zookeeper/prometheus/zookeeper.yaml \"" >> $JAVA_ENV_FILE
