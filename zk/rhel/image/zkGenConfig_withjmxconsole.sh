...
function create_java_env() {
    ...
    echo "JVMFLAGS=\"-Xmx$ZK_HEAP_SIZE -Xms$ZK_HEAP_SIZE -javaagent:/opt/zookeeper/prometheus/jmx_prometheus_javaagent.jar=9404:/opt/zookeeper/prometheus/zookeeper.yaml -Dcom.sun.management.jmxremote.rmi.port=$JMXPORT -Dcom.sun.management.jmxremote.port=$JMXPORT -Djava.rmi.server.hostname=127.0.0.1 -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false \"" >> $JAVA_ENV_FILE
