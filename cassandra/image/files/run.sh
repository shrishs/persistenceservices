...
set -e
CASSANDRA_CONF_DIR=${CASSANDRA_CONF}
...
echo "JVM_OPTS=\"\$JVM_OPTS -javaagent:/usr/local/prometheus/jmx_prometheus_javaagent.jar=9404:/usr/local/prometheus/cassandra-prom.yml \"" >> $CASSANDRA_CONF_DIR/cassandra-env.sh
